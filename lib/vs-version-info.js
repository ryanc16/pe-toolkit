...
const {VS_VERSIONINFO_structure, StringFileInfo_structure, VarFileInfo_structure, VS_FIXEDFILEINFO_structure} = require('./structures');


/**
 * Reads the VS_VERSIONINFO data structure embedded in windows exe, msi, and dlls
 */
function VsVersionInfo() {
    this.result = null;
    /**
     ...
     * @returns {VsVersionInfoResult[]} an array of VsVersionInfoResult
    ...
    this.parseBytes = function(data) {
        ...
        for (const location of keyLocations) {
            ...
            vsVersionInfoTables.push(new VsVersionInfoResult(VS_VERSION_INFO));
        }
 ...
 */
function VsVersionInfoResult(data) {
    this.data = data;
